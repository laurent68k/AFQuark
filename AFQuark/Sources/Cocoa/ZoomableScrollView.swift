//
//  AFZoomableScrollView.swift
//
//
//  Originaly created by tucan9389 on 4/29/18 under ZoomableScrollView name
...
open class AFZoomableScrollView: UIScrollView {
    ...
    deinit {
        ...
        print("ZoomableScrollView.deinit")
        
        //  Laurent: 16/02/2019
        //  On iOS 9 it seems it is mandatory to remove the observer, not only invalidate it as on iOS 12
        //  Thus, I perfome a removeObserver()
    ...
    fileprivate func initialize() {
        ...
        //  Laurent: 13/02/2019
        //  This KeyValue observer is responsible of a big catastrophic memory leaks !
        //  Thus, I added 'weak' !
        self.observation = self.observe(\.bounds) {
    ...
    @objc open func display(view: UIView) {
        ...
        if let zoomView = contentView {
            ...
            //  Laurent
            //  Before, clean up tap recognizer from this object
            if let tapGesture = self.tapGesture {
            
                zoomView.removeGestureRecognizer(tapGesture)
                self.tapGesture = nil
            }
        ...
        self.tapGesture = UITapGestureRecognizer(target: self, action: #selector(AFZoomableScrollView.doubleTapGestureRecognizer(_:)))
    ...
    @objc func doubleTapGestureRecognizer(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if zoomScale >= maximumZoomScale / 2.0 {
            ...
            zoom(to: center,
                 with: AFZoomableScrollView.kZoomInFactorFromMinWhenDoubleTap * minimumZoomScale,
                 animated: true)
        }
    }
...
extension AFZoomableScrollView: UIScrollViewDelegate{
